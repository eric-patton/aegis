...
- `design/godot-ui-mockup-review.md`: the approved D-182 through D-194 visual contract.
...
- Three controlled Help architectures are preserved under
  ...
  Center is approved under D-190. Its search-first category, topic, article, and
  quick-reference path restores the invoking screen and focus, projects canonical
  control metadata where practical, and routes live appearance changes to Settings.
- Three controlled Settings and accessibility architectures are preserved under
  `artifacts/d190-settings-accessibility-architectures-v1/`: Live Preview Workshop,
...
- Controlled focused task-surface systems are preserved under
  ...
  cancellation, permanent-choice warning, and input parity constant. Field Drawer
...
- D-194 approves the final responsive and theme-parity review under
  ...
  destinations, Campaign entry, and shared boundary states. The approved contract carries
  contextual selection memory, one confirmation for reversible zero-cost actions,
  stable target cycling, projected Rest summaries, and exact focus return. The final
  visual contract is closed and implementation is authorized to resume.
