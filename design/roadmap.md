...
- [ ] Scene conversions for the standing plot beats: the faiths' claim at the shrine first (D-116 parked its full ending on this machinery), then the blight and throne climaxes (D-117 follow-on)
