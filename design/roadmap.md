...
- [ ] A1 follow-ons (D-132): the stead event deck writing to the calendar (A2), the
  peddler's restock as a scheduled future (D-124), talk readers for event/hard_winter
  and event/muster_broken after the fact, the calendar in the Snapshot for D4
