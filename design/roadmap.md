...
holes**: none untouched; all four activity families have broken ground (crime opened at D-107, town-life at D-108), though crime and town-life remain the thinnest. Rough fill levels:
...
- Activity families: **wilderness-living core built** (hunting, selling, cooking, foraging: D-070..D-074), the **craft family opened** (cooking D-073; alchemy v1 D-090, the hale-draught), and the **crime family opened** (pilfering D-086; pickpocketing + Sleight D-107; lockpicking D-122); **town life opened** (knucklebones D-108)
...
- [~] Economy v0: shop, rations, repair, herbwife mend, hide-sale, fact-derived prices (D-036,
  ...
  at the wood's edge); caravan/arbitrage at scale pending
...
- [~] Crime: pickpocketing shipped (D-107, v55: 'p' beside one of the stead's folk, the Sleight
  ...
  sitting per lock per world, the guilt-free outlet with no shame and no facts); burglary
  proper, fencing pending (D-006)
- [ ] Fencing wants a fence: a peddler or second settlement before stolen goods have a buyer (D-107)
...
- [~] Town life: gambling shipped (D-108, v56: knucklebones at the skald's hearth, 3 coin the
  ...
  about while the streak stands); carousing, tournaments, property, caravan/arbitrage pending (D-006)
- [ ] A consumer for the light_purse fact (the stead reading a fleeced bearer) (D-108)
- [ ] Carousing as a round-standing verb in the hearth scene (D-108)
