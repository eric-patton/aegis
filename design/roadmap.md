...
holes**: none untouched; all four activity families have broken ground and the two thinnest thickened in D-122/D-124 (crime: pilfering, pickpocketing, lockpicking, and fencing at the peddler's cart; town life: the bones, the round, and both ledgers read), though they still trail wilderness and craft. Rough fill levels:
...
- [ ] More second moves and cry-wakes-dormant-bands; monsters reading the bearer's
  stance (D-096, D-058)
- [ ] Flanking proper, warder rim after the board breaks (D-095; the brawling wall-slam
  cost shipped as guard pressure, D-125)
- [ ] Monsters that read the player's commitment and stance (the other half of D-004) (D-058, D-094)
- [ ] The bearer's own posture bar: foes with pressure verbs, Will's posture clause,
  the bearer's stagger (D-125, D-015)
- [ ] A kind that answers being parried (the drilled thegn first); parry- and
  stance-riding knacks (D-125, D-094)
...
- [~] Crime: pickpocketing shipped (D-107, v55: 'p' beside one of the stead's folk, the Sleight
  skill's dice, one try per pocket per world; clean lifts pay coin and write the secret fact,
  caught lifts ride the unified shame ladder with restitution in the wronged hand); pilfering
  + restitution shipped earlier (D-086); lockpicking shipped (D-122, v65: the locked coffer in
  each fighting deep whose makers were the locking kind, opened on Sleight dice at 'g', one
  sitting per lock per world, the guilt-free outlet with no shame and no facts); fencing
  shipped (D-124, v67: pilfering pockets a trinket off the mantel, and the peddler's cart
  buys everything with a past at 7c apiece, no questions, writing secret/fenced_goods);
  burglary proper pending (D-006)
- [x] Fencing wants a fence: a peddler or second settlement before stolen goods have a buyer (D-107, built D-124: the peddler)
- [ ] A consumer for the secret/fenced_goods fact (the heirloom missed on the lane) (D-124)
