...
- [~] Aspirational sink ladder: property, retinue, master training, commissions (D-025, D-036);
  the stead half's first rung shipped as the facility ladder (A3 v1, D-134), its next two
  works are A3 v2, the town half is B2's property rung
...
- [ ] A3 v1 follow-ons (D-134): a shared-nine topic-budget audit (the season's-news
  topic can still co-occur with a full board at the other offer-keeping doors);
  facility teeth for weather when the deck grows (a granary clause against the
  washout's take)
