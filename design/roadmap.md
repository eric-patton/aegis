...
- **Phase 2: A keystone pillar (current).** **Factions started (D-076..D-078):** the
  ...
  War of Faiths, now scoped (D-114): first the two-faiths worldgen lane (the order at
  the harrow, the keeper at the stead's shrine), then the template itself. **Magic, the alternative keystone, landed (D-091):** Mind and Will wake,
...
- [~] Crime: pickpocketing shipped (D-107, v55: 'p' beside one of the stead's folk, the Sleight
  ...
  + restitution shipped earlier (D-086); lockpicking, burglary proper, fencing pending (D-006)
...
- [ ] The two-faiths worldgen lane: the order's site (the harrow) and its folk, the keeper cast at the stead's shrine, the founding planted in history, topics both sides (D-114; builds before the template)
- [ ] Story template: War of Faiths (scoped D-114; wants the two-faiths worldgen lane first) (D-020)
