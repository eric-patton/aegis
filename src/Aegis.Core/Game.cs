    ...
    private void CrossToNextWorld(IReadOnlyList<OathId> oaths)
    {
        ...
        foreach (var kept in keptTruths)
            World.Facts.Add("silence", kept.Subject, kept.Object, kept.Subject switch
            {
                ...
                "mere_truth" => $"Out of a world called {prevWorld}, a story: the black mere above {prevSettlement}, the hungry thing walled under its holm in the first days, and the watch on the banks that starved it still at last. Every teller has it the same way.",
