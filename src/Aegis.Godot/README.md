...
D-182 Phases 1 through 3 and their D-196 through D-200 review remediation are implemented. Creation, the
...
and Pack into their first parity pass. D-200 corrects Character Creation density and
scroll ownership, keeps the world Activity sidebar permanent, and rebuilds Character
around the approved rail, dense active-record list, deep inspector, and one-at-a-time
compact flow. The approved mockup architecture is canonical, while
