...
public class SkillsTests
{
    ...
    public void Sheet_OpensOnC_TakesNoTurn_ShowsBothLedgers_AndAnyKeyCloses()
    {
        ...
        Assert.Equal("blades:0:0,hafted:1:12,brawling:0:0,warding:0:0,ranged:0:0,hunting:0:0,cooking:0:0,survival:0:0,spellcraft:0:0,sleight:0:0,smithing:0:0", snap.Skills);
